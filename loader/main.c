/* main.c -- Final Fantasy 4: After Years .so loader
 *
...
int main_thread(SceSize args, void *argp) {
	...
	switch (lang) {
	case 8: // Korean
		initFont("app0:/NotoSansKR-Regular.ttf");
		break;
	case 9: // Simplified Chinese
	case 10: // Traditional Chinese
		initFont("app0:/NotoSansSC-Regular.ttf");
		break;
	default:
		initFont("app0:/NotoSansKR-Regular.ttf");
		break;
	...
	while (1) {
		...
		ff4a_touch(0, 0, reportNum, reportNum, coordinates[0], coordinates[1],
